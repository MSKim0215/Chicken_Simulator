...
public class RootDNA 
{
    ...
    public virtual void CombineGenes(ChickensDNA dna1, ChickensDNA dna2)
    {
    ...
    public virtual void CombineStat(ChickensDNA dna1, ChickensDNA dna2, float statValue = 1f)
    {
        ...
        //        {
        //            newStat.Stats.Add(statType, dna1.StatusCode.GenesStats[statType]);
        //        }
        //    }
        //    else
        ...
        //        if (!newStat.Stats.ContainsKey(statType))
        //        {
        //            newStat.Stats.Add(statType, dna2.StatusCode.GenesStats[statType]);
        //        }
        //    }
        //}
        //StatusCode = newStat;
